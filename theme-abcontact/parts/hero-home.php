<?php
/**
 * Hero section specific for front-page.
 *
 * This hero template is designed for the home page with customizer settings,
 * eyebrow text, CTA buttons, and optional background image.
 *
